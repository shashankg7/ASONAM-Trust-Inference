...
def test_segment(epochs):
    ...
    for i in xrange(1):
        ...
        print("accuracy_score with High-high in-degree filter is  %f"%(accuracy_score(Y, yp)))
        ...
        print("accuracy_score with High-low in-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with low-high in-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with low-low in-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with High-high out-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with High-low out-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with low-high out-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
        ...
        print("accuracy_score with low-low out-degree filter is  %f"%(accuracy_score(Y, yp)))
        #print(accuracy_score(Y, yp))
